...
contract ERC4519 is ERC721, IERC4519{
    ...
    function createToken(address _addressSD, address _addressOwner) public returns (uint256){
    ...
    function setUser(uint256 _tokenId, address _addressUser) public virtual override payable {
    ...
    function startOwnerEngagement(uint256 _tokenId, uint256 _dataEngagement, uint256 _hashK_O) public virtual override payable {
    ...
    function ownerEngagement(uint256 _hashK_D) public virtual override payable {
    ...
    function startUserEngagement(uint256 _tokenId, uint256 _dataEngagement, uint256 _hashK_U) public virtual override payable {
    ...
    function userEngagement(uint256 _hashK_D) public virtual override payable{
        uint256 _tokenId = tokenFromBCA(msg.sender);
